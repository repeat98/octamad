...
| WP-A2 The layout | review | `machinedrum` | `PENDING` | 2026-09-23 | `machinedrum_reports/WP-A2.md` | concrete non-overlapping MD map; user must choose stock-slot and voice-home trade-offs |
