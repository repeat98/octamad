...
| WP-A6 The cycle report at OT addresses | review | `machinedrum` | this commit | 2026-09-25 | `machinedrum_reports/WP-A6.md` | under the firmware's dispatch (port): driver 676–1,571 instr/sample by kit, worst frame of 16 × EFM-CB 1,924 incl. packets and mix (🟡 ~2,830 cycles vs ~3,120 usable); hardware ceiling needs a burn image |
