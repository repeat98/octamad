...
| WP-B2 Build-time extraction | blocked | `machinedrum` | `50ecf58` | 2026-09-24 | `machinedrum_reports/WP-B2.md` | audit consumes pinned inputs and assembles the driver, but the proposed sine/source span collides; user must sign off a packed split or revised owner map | |
