...
| WP-A3 Layout-driven relocation and driver | claimed | 2026-09-24 | machinedrum | `md_relocate.py`/`md_driver.py` will consume `modules/machinedrum/layout.py`; twelve-kit gate pending | |
